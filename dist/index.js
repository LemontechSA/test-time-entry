...
var TimeEntry = function (props) {
    ...
    return (React__default.createElement("div", { className: classnames(css$2.container, (_a = {},
        ...
        React__default.createElement("div", { className: css$2.footer },
            React__default.createElement("div", { className: css$2.duration },
                active && React__default.createElement(TimerIcon, { animate: true, size: 14 }),
                active
                    ? convert$1.duration(duration).toTimeString()
                    : convert$1.duration(duration).toDurationString()),
            hover && !active && (React__default.createElement(FontAwesomeIcon, { icon: faPlay, onClick: function () { return onActiveChange(true); } })),
            active && (React__default.createElement(FontAwesomeIcon, { icon: faPause, onClick: function () { return onActiveChange(false); } })))));
};
